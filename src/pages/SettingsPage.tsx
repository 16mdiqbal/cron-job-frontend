...
export const SettingsPage = () => {
  ...
  const activeTab = useMemo<SettingsTab>(() => {
    ...
    const allowed: SettingsTab[] =
      user?.role === 'admin'
        ? ['profile', 'notifications', 'email', 'security', 'categories', 'pic-teams', 'slack']
        : ['profile', 'notifications', 'email', 'security'];

    if (tab && (allowed as string[]).includes(tab)) return tab as SettingsTab;
    return 'profile';
